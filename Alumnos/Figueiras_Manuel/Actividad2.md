...
* *Estrategias de Busquedas:* 
    ...
    Búsqueda:
     ...
     ("machine learning" OR "aprendizaje automático")
    AND ("biometric data" OR "datos biométricos")
    AND ("type 2 diabetes" OR "diabetes mellitus tipo 2")
    AND ("early detection" OR "detección temprana")
